...
以下 11 件は本書の権限を超える。**各件に推奨を付す**。（1〜4 は 2026-08-07、5〜8 は WP-2.6 remediation で追加、9・10 は WP-2.7 実装中に追加、11 は WP-3.3 で追加、いずれも 2026-08-08。**9・10・11 は裁定済み**。11 はオーナー裁定により**推奨 (a) を採らず保存**、稼働系への修正は cutover 後 — D2 に 1 件を owe している）

...
const LANG = {
  ...
  ja: {
    ...
    'drill_modal.llm.sha256':         'SHA-256',
    'drill_modal.section.feedback':       'アナリスト feedback',
    ...
    'drill_modal.feedback.submit':            'Feedback 送信',
    'drill_modal.feedback.summary_meta':      '合計: {total} • 個別 analyst 数: {distinct}',
    'drill_modal.feedback.summary_empty':     'この結論への feedback はまだありません。',
    'drill_modal.feedback.disabled':          '未保存の結論には feedback を送信できません。',
    'drill_modal.feedback.status.no_label':   'ラベルを選択してください。',
    'drill_modal.feedback.status.submitting': '保存中…',
    'drill_modal.feedback.status.saved':      'Feedback を保存しました。',

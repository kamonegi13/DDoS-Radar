...
const LANG = {
  en: {
    ...
    'watchpane.tip.history_shallow':  'Sparkline shows the current cycle only — full 1h history requires the upcoming sensor_observation_ts schema (§7.1).',
  ...
  ja: {
    ...
    // ══════════════════════════════════════════════════════════════
    // NP7 最終判断 disclaimer バナー (v2 conclusions API)
    // ══════════════════════════════════════════════════════════════
    'banner.np7.fallback':            '本ツールの結論であり、最終判断は組織のプロセスによって行われます。',

    // ══════════════════════════════════════════════════════════════
    // 結論カード (Layer 1 — v2 conclusions envelope)
    // docs/design/v2-ui.md §4 参照
    // ══════════════════════════════════════════════════════════════
    ...
    // Drill-down モーダル (Layer 2 — audit_trace)
    'drill_modal.title':              '結論導出経路 (Audit Trace)',
    'drill_modal.close':              '[ X ] 閉じる',
    ...
    'watchpane.tip.history_shallow':  'sparkline は現サイクルのみ表示 — 1h 履歴は新 sensor_observation_ts schema (§7.1) 実装後に有効化。',
    ...
    'panel.tradecraft.ach.credibility':          '信頼性 1–5(ソースの信頼度)',
    ...
    'panel.tradecraft.assumptions.conf_low':     '低信頼度',
    'panel.tradecraft.assumptions.conf_med':     '中信頼度',
    'panel.tradecraft.assumptions.conf_high':    '高信頼度',

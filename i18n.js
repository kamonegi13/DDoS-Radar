...
const STRINGS = {
    ...
    'drill_modal.calib.fn':           'False negatives (missed)',
    'drill_modal.calib.sample_n':     'Labeled sample (n)',
    'drill_modal.calib.last_label_at': 'Last label at',
    'drill_modal.calib.warn_degraded': 'Recall below floor — the tool is missing real escalations (NP1)',
    ...
    'modal.help.ch4':                 '4. HUD & Panels',
    'modal.help.ch5':                 '5. Workflow',
    'modal.help.ch6':                 '6. Sensors',
    'modal.help.ch7':                 '7. Scoring',
    'modal.help.ch8':                 '8. Calibration',
    'modal.help.ch9':                 '9. Tradecraft',
    'modal.help.ch10':                '10. Recall',
    ...
    'panel.llm_intel.confirm_failed':       'Confirm failed: {reason}',
    'panel.llm_intel.reject_failed':        'Reject failed: {reason}',
    'panel.llm_intel.revert_failed':        'Revert failed: {reason}',
    ...
    'settings.tune.zscore':            'Z-Score Baseline',
    'settings.tune.sequence':          'Sequence Chain',
    'settings.tune.ddos':              'DDoS Engine',
    'settings.tune.narrative':         'Narrative Burst',
    'settings.tune.airspace':          'Airspace',
    'settings.tune.maritime':          'Maritime / ISR',
    'settings.tune.gdelt':             'GDELT',
    'settings.infra.network':          'Network / SSL',
    'settings.infra.cache':            'Cache',
    'settings.infra.poll':             'Polling Intervals',
    'settings.infra.server':           'Server / Bootstrap',
    'settings.infra.plugins':          'Plugins',
    'settings.infra.fetch_log':        'Fetch Log',
    'settings.access.users':           'Users / Roles',
    'settings.access.api_keys':        'API Keys',
    'settings.access.webhooks':        'Webhooks',
    'settings.access.jwt':             'JWT Policy',
    'settings.access.admin':           'Admin Bootstrap',

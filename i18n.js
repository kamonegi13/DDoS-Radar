...
const LANG = {
  en: {
    ...
    'panel.tradecraft.col.claim':                'Claim',
    'panel.tradecraft.col.evidence':             'Evidence',
    'panel.tradecraft.col.weight':               'W',
    ...
    'panel.tradecraft.weight.weak':              'Weak',
    'panel.tradecraft.weight.medium':            'Medium',
    'panel.tradecraft.weight.strong':            'Strong',
    'panel.tradecraft.weight.decisive':          'Decisive',
    ...
    'panel.tradecraft.disconf.claim_ph':         'What current claim does this contradict? (e.g. "Taiwan invasion timeline ≤30d")',
    'panel.tradecraft.disconf.evidence_ph':      'Evidence (what observation, citation, or analysis disconfirms it)',
    'panel.tradecraft.disconf.source_ph':        'Source URL (optional)',
    ...
    'panel.tradecraft.ach.help':                 'Heuer Analysis of Competing Hypotheses. Score each evidence item from −− (very inconsistent) to ++ (very consistent) for each hypothesis. The lowest negative tally is most likely to be true.',
    ...
    'panel.tradecraft.ach.diag_low':             'Low diagnosticity',
    'panel.tradecraft.ach.diag_med':             'Medium diagnosticity',
    'panel.tradecraft.ach.diag_high':            'High diagnosticity',
    'panel.tradecraft.ach.need_both':            'Add at least one hypothesis and one evidence item to begin scoring.',
    'panel.tradecraft.ach.tally_help':           'Σ row = sum of (score × diagnosticity). The hypothesis with the LEAST negative Σ is least disconfirmed.',
    ...
    'panel.tradecraft.dissent.pos_ph':           'Dissenting position (what do you think the consensus is missing?)',
    'panel.tradecraft.dissent.rat_ph':           'Rationale / supporting reasoning',
    'panel.tradecraft.dissent.position':         'Position',
    'panel.tradecraft.dissent.rationale':        'Rationale',
    ...
    'panel.tradecraft.assumptions.conf_low':     'Low confidence (0.30)',
    'panel.tradecraft.assumptions.conf_med':     'Medium confidence (0.60)',
    'panel.tradecraft.assumptions.conf_high':    'High confidence (0.85)',
    ...
    'panel.tradecraft.premortem.help':           'Pre-Mortem (Klein 2007). Imagine this scenario fails: enumerate failure modes, indicators that would surface them, and mitigations.',
    'panel.tradecraft.premortem.empty':          'No pre-mortem entries yet.',
    'panel.tradecraft.premortem.mode_ph':        'Failure mode (how could this scenario reading turn out wrong?)',
    'panel.tradecraft.premortem.indicator_ph':   'Early indicator (what observation would warn us first?)',
    'panel.tradecraft.premortem.mitigation_ph':  'Mitigation (what would we do?)',
    'panel.tradecraft.premortem.indicator':      'Indicator',
    'panel.tradecraft.premortem.mitigation':     'Mitigation',
    'panel.tradecraft.premortem.sev_low':        'Low severity',
    'panel.tradecraft.premortem.sev_med':        'Medium severity',
    'panel.tradecraft.premortem.sev_high':       'High severity',
    'panel.tradecraft.premortem.resolved':       'Resolved',
    'panel.tradecraft.premortem.resolve_prompt': 'Resolution note:',
  ...
  ja: {
    ...
    'panel.tradecraft.col.claim':                '主張',
    'panel.tradecraft.col.evidence':             '証拠',
    'panel.tradecraft.col.weight':               '重み',
    ...
    'panel.tradecraft.weight.weak':              '弱',
    'panel.tradecraft.weight.medium':            '中',
    'panel.tradecraft.weight.strong':            '強',
    'panel.tradecraft.weight.decisive':          '決定的',

    'panel.tradecraft.hidden.help':              'FIRED したが、ミュート/ノイズ分類/低信頼度などで抑制されたシグナル。データは存在するがスコアに寄与していない「データの出口」を可視化する。',
    ...
    'panel.tradecraft.disconf.claim_ph':         'どの主張に矛盾するか?(例:「台湾有事タイムライン ≤30日」)',
    'panel.tradecraft.disconf.evidence_ph':      '証拠(どの観測・引用・分析が反証するか)',
    'panel.tradecraft.disconf.source_ph':        'ソースURL(任意)',
    ...
    'panel.tradecraft.ach.help':                 'Heuer 競合仮説分析(ACH)。各証拠を仮説ごとに −−(非常に矛盾)から ++(非常に一致)まで評価。最も負のタリーが小さい仮説が最も真である可能性が高い。',
    ...
    'panel.tradecraft.ach.diag_low':             '低診断性',
    'panel.tradecraft.ach.diag_med':             '中診断性',
    'panel.tradecraft.ach.diag_high':            '高診断性',
    'panel.tradecraft.ach.need_both':            '採点を始めるには仮説と証拠を1つ以上追加してください。',
    'panel.tradecraft.ach.tally_help':           'Σ 行 = (スコア × 診断性)の合計。Σ が最も負でない仮説が最も否定されていない。',
    'panel.tradecraft.dissent.help':             '少数意見を記録。コンセンサスに埋もれず明示的に異論を残す(デビルズ・アドボケイト)。',
    'panel.tradecraft.dissent.empty':            '少数意見は登録されていません。',
    'panel.tradecraft.dissent.pos_ph':           '異論内容(コンセンサスが見落としているものは何か?)',
    'panel.tradecraft.dissent.rat_ph':           '根拠 / 補強推論',
    'panel.tradecraft.dissent.position':         '立場',
    'panel.tradecraft.dissent.rationale':        '根拠',
    ...
    'panel.tradecraft.assumptions.conf_low':     '低信頼度 (0.30)',
    'panel.tradecraft.assumptions.conf_med':     '中信頼度 (0.60)',
    'panel.tradecraft.assumptions.conf_high':    '高信頼度 (0.85)',
    'panel.tradecraft.assumptions.confidence':   '信頼度',
    ...
    'panel.tradecraft.premortem.help':           'プリモーテム(Klein 2007)。このシナリオが外れた前提で、失敗モード・先行指標・緩和策を列挙。',
    'panel.tradecraft.premortem.empty':          'プリモーテム項目はありません。',
    'panel.tradecraft.premortem.mode_ph':        '失敗モード(このシナリオ評価がどう外れうるか?)',
    'panel.tradecraft.premortem.indicator_ph':   '先行指標(最初に何を観察すれば警告できるか?)',
    'panel.tradecraft.premortem.mitigation_ph':  '緩和策(発生時にどう動くか?)',
    'panel.tradecraft.premortem.indicator':      '指標',
    'panel.tradecraft.premortem.mitigation':     '緩和策',
    'panel.tradecraft.premortem.sev_low':        '重大度 低',
    'panel.tradecraft.premortem.sev_med':        '重大度 中',
    'panel.tradecraft.premortem.sev_high':       '重大度 高',
    'panel.tradecraft.premortem.resolved':       '解決済み',
    'panel.tradecraft.premortem.resolve_prompt': '解決ノート:',
    ...
    'panel.llm_intel.cred_tier_tip':             '{tier} ソース · {src} · 信頼度 {val}',

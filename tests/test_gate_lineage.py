...
class TestWiring:
    ...
    # NOTE (prod/phase01-h05): three doc-fidelity tests that read
    # docs/design/v3/{S5-verification,D2-defects}.md were removed here.
    # Those files are part of the v3 rebuild's design-doc tree, which is
    # deliberately out of scope for this PR (v3/ has not been merged to
    # main). They asserted the *documentation* stayed in sync with the
    # G-08 degenerate-cell count correction (4 -> 5) and CUT-07's status
    # — content facts about the v3 program, not behavior of the shipped
    # radar/verification/gate_lineage.py module, which every other test

...
# v1 sunset observation helpers were removed 2026-04-29 alongside the
# early ADR-V2-003 sunset. Historical residual rows under the
# 'v1_sunset_route:' prefix remain in legacy_access_log for audit; the
# table itself stays for the SR4 (?theater= dual-read) telemetry that
# is on a separate 2026-10-01 schedule. The summarize_v1_sunset helper
# and V1SunsetSummary dataclass are no longer needed because the routes
# they observed have been deleted.
